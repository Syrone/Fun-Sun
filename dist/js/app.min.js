...
document.addEventListener('DOMContentLoaded', function () {
  ...
  dropdownCalendars.forEach(function (dropdownCalendar, index) {
      ...
      actions: {
        clickDay: function clickDay(e, dates) {
          ...
          if (dates[1]) {
            ...
            selectedDate.textContent = "".concat(dateSelectedFormatter(dates[0]), " - ").concat(dateSelectedFormatter(dates[dates.length - 1]));
          } else if (dates[0]) {
    ...
    calendar.init();
    var selectedDate = dropdownCalendar.querySelector('.vanilla-calendar-top__selected_date');
    var calendarType = calendar.currentType;
    function handleCalendarChanges() {
      var vanillaCalendarDays = dropdownCalendar.querySelectorAll('.vanilla-calendar-days');
    ...
    var observerCalendar = new MutationObserver(function (mutationsList, observer) {
      ...
      if (calendarType === 'multiple') {
        requestAnimationFrame(function () {
          ...
          if (selectedDates.length === 1) {
            ...
            selectedDate.textContent = "".concat(dateSelectedFormatter(firstDate), " - ").concat(dateSelectedFormatter(lastDate));
          } else {
            handleCalendarTypeChange(selectedDate);
          }
        });
