...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (canvasMarketingDivision) {
    var graphMarketingDivision = new Chart(canvasMarketingDivision, {
      type: 'doughnut',
      data: {
        labels: ['Operational Marketing', 'Advertising', 'E-Commerce', 'SMM B2C', 'Franchising', 'ЗТА'],
        datasets: [{
  ...
  if (canvasQuantityByMonth && canvasQuantityByMonthAxesY) {
    var createDiagonalPattern = function createDiagonalPattern(colorStroke, colorFill) {
    ...
    var dates = [new Date('2022-01-01'), new Date('2022-02-13'), new Date('2022-03-21'), new Date('2022-04-11'), new Date('2022-05-06'), new Date('2022-06-26'), new Date('2022-07-24'), new Date('2022-08-24'), new Date('2022-09-02'), new Date('2022-10-11'), new Date('2022-11-11'), new Date('2022-12-01')];
    var data = {
      labels: dates,
      datasets: [{
        label: 'Выполненных',
    ...
    var getOrCreateTooltip = function getOrCreateTooltip(chart) {
      ...
      if (!tooltipEl) {
        ...
        var tooltipTriangle = document.createElement('span');
        var tooltipSvg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    ...
    var externalTooltipHandler = function externalTooltipHandler(context) {
      ...
      if (tooltip.dataPoints.length > 0) {
        ...
        var _data = tooltip.dataPoints[0].dataset.data[tooltip.dataPoints[0].dataIndex];
        ...
        var tooltipTitle = document.createTextNode(_data + ' ' + label);
